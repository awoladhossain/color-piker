...
(function () {
  ...
  var hexCalculator = {
    setColorBrightness: function (color, deltaBrightness) {
      ...
      let hexR =
        newRGBA.r.toString(16).length == 1
          ? "0" + newRGBA.r.toString(16)
          : newRGBA.r.toString(16);
      let hexG =
        newRGBA.g.toString(16).length == 1
          ? "0" + newRGBA.g.toString(16)
          : newRGBA.g.toString(16);
      let hexB =
        newRGBA.b.toString(16).length == 1
          ? "0" + newRGBA.b.toString(16)
          : newRGBA.b.toString(16);
      return "#" + hexR + hexG + hexB;
    },
    toRGBA: function (hexString) {
      var hexRegex =
        /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})?/i.exec(hexString);
      return hexRegex
        ? {
    ...
    isValidHex: function (hexString) {
      var hexRegex =
        /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})?\b/i.exec(
          hexString
        );
  ...
  var outputCell = {
    ...
    getHTML: function () {
      ...
      this.colorTypeTitleLabel.appendChild(
        document.createTextNode(this.colorType)
      );
      ...
      this.colorValueLabel.appendChild(
        document.createTextNode(this.colorValue)
      );
    ...
    setColor: function (color) {
      ...
      var css =
        ...
        color +
        "; color: " +
        hexCalculator.contrastColor(color) +
        " } " +
        ".outputCell:active {background-color: " +
        color +
        "}";
    ...
    buttonEvent: function (e) {
      ...
      if (window.getSelection()) {
        ...
        range.selectNodeContents(
          document.getElementById(this.colorType).lastChild
        );
    ...
    startTracking: function () {
      ...
      document.onmousemove = function (e) {
        ...
        for (var key in selfEyes.eyes) {
          ...
          let eyePupilMargins = selfEyes.calculateMouseToPupilMargins(
            eye,
            mouseX,
            mouseY
          );
